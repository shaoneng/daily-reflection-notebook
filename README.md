...
- 下一步追踪，支持 AI 建议待确认、建议去重和质量筛选、未完成任务带入今天、今日焦点、长期追踪、手动添加、状态更新和删除
...
- [pending] 回看今天的 DeepSeek 配置记录
  - 来源：AI 复盘 / 需要回看或复习的旧内容
...
“AI 建议待确认”会过滤过泛建议，并和已有下一步、已有建议做相似度去重。页面里的“长期追踪”会按所选日期展示近 7 天完成率、近 30 天未关闭/已关闭任务，以及反复延续的未完成任务。
